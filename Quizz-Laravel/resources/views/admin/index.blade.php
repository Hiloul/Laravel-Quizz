                            ...
                            <tr data-entry-id="{{ $result->id }}">
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('admin.show', $result->id) }}" class="btn btn-success">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.edit', $result->id) }}" class="btn btn-info">
                                            <i class="fa fa-pencil-alt"></i>
                                        </a>
                                        <form onclick="return confirm('are you sure ? ')" class="d-inline" action="{{ route('admin.destroy', $result->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
